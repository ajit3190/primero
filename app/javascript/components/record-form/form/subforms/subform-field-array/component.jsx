...
const Component = ({
  ...
  const fieldMappings = [
    ...
    { label: "Vision wear glass", key: `cfm_${latestValue?.cfm_age}_hearing_uses_hearing_aid` },
    { label: "Difficulty hearing with hearing aid", key: `cfm_${latestValue?.cfm_age}_hearing_difficulty_with_hearing_aid` },
    { label: "Vision wear glass", key: `cfm_${latestValue?.cfm_age}_mobility_uses_equipment` },
