  ...
  class << self
    def exporter(record_type, format)
      [
        ...
        Exporters::RolePermissionsExporter, Exporters::MRMViolationExporter,Exporters::UserExporter
      ].find do |exporter|
    ...
    def enqueue(bulk_export, password = nil, start_date = nil, end_date = nil)
      ...
      BulkExportJob.perform_later(bulk_export.id, encrypted_password, start_date, end_date)
    end
